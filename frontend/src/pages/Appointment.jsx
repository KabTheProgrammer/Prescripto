...
const Appointment = () => {
  ...
  const bookAppointment = async () => {
    ...
    if (!docSlots[slotIndex]) {
      toast.error("Invalid slot selection. Please choose a valid slot.");
      return;
    }
    ...
    if (!docId) {
      toast.error("Doctor ID is missing. Unable to book an appointment.");
      return;
    }
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            {/* ---------- Doc Info: name, degree, experiencec -------- */}
